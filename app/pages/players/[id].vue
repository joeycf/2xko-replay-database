  ...
  <div class="mx-auto w-full max-w-[1440px]">
    ...
    <div class="relative overflow-hidden border-b border-white/[0.09] px-4 py-8 md:px-10 md:py-[34px]">
      ...
      <div class="relative flex flex-wrap items-center gap-5 md:gap-[26px]">
        <div
          ...
          aria-hidden="true"
        >
          <span class="font-display text-[34px] font-bold text-accent/70 md:text-[44px]">{{ initials }}</span>
        </div>
        <div class="min-w-0">
          <div
          ...
          >
            ...
            <span class="font-sans text-[10px] font-bold uppercase tracking-[.16em] text-accent">Verified Pro</span>
          </div>
          <h1
    ...
    <div class="px-4 pb-7 pt-1.5 md:px-7">
      <div class="mb-4 flex items-center gap-2.5">
        ...
        <span class="font-mono text-[12px] text-ink-muted">{{ matches.toLocaleString('en-US') }} matches</span>
      </div>
      <ClientOnly>
        <ReplayGrid
          :list="replays"
