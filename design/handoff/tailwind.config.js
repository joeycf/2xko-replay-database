/** ============================================================
 *  2XKO Replay Database — Tailwind config (Nuxt 3)
 *  Pairs with tokens.css. Values are duplicated as literals here
 *  so utilities work without CSS-var indirection; swap to
 *  `var(--token)` if you prefer a single source of truth.
 *  ============================================================ */
