...
_Generated 2026-08-29T22:32:24.885Z._

## Summary
- Total videos: **6538**
- High confidence: **6511**  ·  Low confidence: **17**  ·  Manual (hand-authored): **10**
...
- Season derivation (date-authoritative) — boundary-graced: **6** · stale description labels overridden: **628**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2477 | fetched |
| `highLevel` | 1825 | fetched |
