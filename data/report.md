...
_Generated 2026-09-26T11:27:38.791Z._

## Summary
- Total videos: **6722**
- High confidence: **6691**  ·  Low confidence: **21**  ·  Manual (hand-authored): **10**
- Newly discovered players (auto-added to `players.json`): **0**
- Fill rates — season: **95.5%** · patchVersion: **95.3%** · patch label: **16.8%** · fuse: **99.4%**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2590 | fetched |
| `highLevel` | 1896 | fetched |
