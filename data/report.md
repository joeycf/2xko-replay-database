...
_Generated 2026-09-20T11:27:08.959Z._

## Summary
- Total videos: **6682**
- High confidence: **6651**  ·  Low confidence: **21**  ·  Manual (hand-authored): **10**
- Newly discovered players (auto-added to `players.json`): **0**
- Fill rates — season: **95.5%** · patchVersion: **95.3%** · patch label: **16.5%** · fuse: **99.4%**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2567 | fetched |
| `highLevel` | 1879 | fetched |
