...
_Generated 2026-09-21T12:51:34.657Z._

## Summary
- Total videos: **6689**
- High confidence: **6658**  ·  Low confidence: **21**  ·  Manual (hand-authored): **10**
- Newly discovered players (auto-added to `players.json`): **0**
- Fill rates — season: **95.5%** · patchVersion: **95.3%** · patch label: **16.5%** · fuse: **99.3%**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2571 | fetched |
| `highLevel` | 1882 | fetched |
