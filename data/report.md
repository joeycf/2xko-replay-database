...
_Generated 2026-09-22T11:41:40.601Z._

## Summary
- Total videos: **6696**
- High confidence: **6665**  ·  Low confidence: **21**  ·  Manual (hand-authored): **10**
- Newly discovered players (auto-added to `players.json`): **0**
- Fill rates — season: **95.5%** · patchVersion: **95.3%** · patch label: **16.6%** · fuse: **99.8%**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2575 | fetched |
| `highLevel` | 1885 | fetched |
