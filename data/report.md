...
_Generated 2026-09-25T11:53:42.707Z._

## Summary
- Total videos: **6716**
- High confidence: **6685**  ·  Low confidence: **21**  ·  Manual (hand-authored): **10**
- Newly discovered players (auto-added to `players.json`): **0**
- Fill rates — season: **95.5%** · patchVersion: **95.3%** · patch label: **16.7%** · fuse: **99.5%**
...
| source | records | mode |
|---|---|---|
| `bestReplays` | 2586 | fetched |
| `highLevel` | 1894 | fetched |
