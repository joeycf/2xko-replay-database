...
_Generated 2026-07-27T10:10:53.536Z._

## Summary
- Total videos: **5292**
- High confidence: **5251**  ·  Low confidence: **11**  ·  Manual (hand-authored): **30**
- Newly discovered players (auto-added to `players.json`): **4**
- Fill rates — season: **95.1%** · patchVersion: **94.8%** · patch label: **15.7%** · fuse: **99.6%**
- Season derivation (date-authoritative) — boundary-graced: **14** · stale description labels overridden: **519**
...
|---|---|---|---|
| `nyudu` | Nyudu | 2 | nyudu |
| `sayuswy` | SayuSwy | 1 | sayuswy |
| `3henjoyer` | 3H ENJOYER | 1 | 3h enjoyer |
| `kic` | KIC | 1 | kic |
